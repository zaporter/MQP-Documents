...
\begin{center}
    \Huge{\textbf{Explorant: A Code Exploration and Onboarding Tool}} \\ % Input title of MQP
    ...
    \vspace{5mm} % Add vertical space between sections
    Prof. Robert J. Walls \\ % Input name of first advisor
    Prof. Gary Pollice \\  % Input name of second advisor
    \vspace {15mm} % Add vertical space between sections
